...
public class SidReader {
    ...
    public void readSidsFromFile(InputStream inputStream, SidCache sidCache) {
        FixedWidthFields fieldLengths = new FixedWidthFields(FNR, FNR_NAA, SNR_UTGATT, SNR, DATO_FNR, DATO_FNRNAA , DATO_SNR, RDATO_SNR);
        FixedWidthParserSettings settings = new FixedWidthParserSettings(fieldLengths);
        settings.setHeaders("fnr", "fnr_naa", "snr_utgatt", "snr", "dato_fnr", "dato_fnrnaa", "dato_snr", "rdato_snr");
